...
function M.config()
  ...
  fidget.setup({
    ...
    progress = {
      ...
      ignore_done_already = true, --false,  -- Ignore new tasks that are already complete
      ignore_empty_message = true, -- false, -- Ignore new tasks that don't contain a message
      ...
      display = {
        ...
        done_icon = icons.ui.BoldCheck, -- Icon shown when all LSP progress tasks are complete
        done_style = "Constant",      -- Highlight group for completed LSP tasks
        progress_ttl = math.huge,     -- How long a message should persist when in progress
        progress_icon =               -- Icon shown when LSP progress tasks are in progress
        { pattern = "meter", period = 1 },
